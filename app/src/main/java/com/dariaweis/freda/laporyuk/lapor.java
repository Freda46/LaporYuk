...
//        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, this);
    ...
    private void submitLapor(freda freda) {

        database.child("freda").push().setValue(freda).addOnSuccessListener(this, new OnSuccessListener<Void>() {
            @Override
    ...
    private void insert(){
        submitLapor(new freda(nama.toString(),waktu.toString(), editLapor.getText().toString(), lat.toString(), lng.toString()));
